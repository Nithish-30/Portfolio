        ...
        <div class="row gx-lg-5 align-items-center px-5">
            <div class="col-xxl-5 pt-lg-5">
                ...
                <div class="text-xxl-start mt-4">
                    ...
                    <div class="card border-0 mb-3 align-items-md-start justify-content-md-start">
                        <div class="card-body">
                            <div class="p-2">
                    ...
                    <div class="d-grid gap-3 d-sm-flex justify-content-center justify-content-xxl-start mx-4 pb-5">
            ...
            <div class="col-xxl-6 col-xl-6 mx-xxl-5 mt-xxl-5 p-xxl-5">
                ...
                <div class="d-flex justify-content-center">
                    <div class="col-12 pb-0">
                        <img class=" mx-xxl-5 img-fluid rounded-4 mx-md-4" src="<?php echo $profile; ?>" alt="Profile Picture" />
                    </div>
                </div>
            </div>
        </div>
